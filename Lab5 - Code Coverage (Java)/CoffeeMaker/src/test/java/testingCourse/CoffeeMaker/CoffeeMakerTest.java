...
public class CoffeeMakerTest {
	...
	public void AddRecipe() {
		...
		// TODO: changed from assertFalse to assertTrue, the function returns true because it acts as intended.
		assertTrue(cm.addRecipe(r4));
		// TODO: changed the object we want to check from "null" to r4 which is the actual object.
		assertEquals(cm.getRecipeForName("Hot Chocolate"), r4);
	}
